...
server.prototype.start = function(){
    ...
    return new Promise(function(resolve, reject){
        async.waterfall([
            function(callback) { // Override project path if CLI
                setProjectPath(that.basePath, callback);
            },
...
var setProjectPath = function(basePath, cb){
    global.__projectPath = basePath ? basePath : findRoot.getProjectRoot();
    cb(null);
};
